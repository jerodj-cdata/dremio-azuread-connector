...
@SourceType(value = "AzureADARP", label = "AzureAD",uiConfig = "azuread-layout.json")
public class AzureADConf extends AbstractArpConf<AzureADConf> {
  private static final String ARP_FILENAME = "arp/implementation/azuread-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.azuread.AzureADDriver";
